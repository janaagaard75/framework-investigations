...
(function (global, factory) {
    ...
    jQuery.extend({
        ...
        when: function (subordinate) {
            var i = 0, resolveValues = slice.call(arguments), length = resolveValues.length, remaining = length !== 1 ||
                (subordinate && jQuery.isFunction(subordinate.promise)) ? length : 0, deferred = remaining === 1 ? subordinate : jQuery.Deferred(), updateFunc = function (i, contexts, values) {
    ...
    function adjustCSS(elem, prop, valueParts, tween) {
        var adjusted, scale = 1, maxIterations = 20, currentValue = tween ?
            ...
            function () { return jQuery.css(elem, prop, ""); }, initial = currentValue(), unit = valueParts && valueParts[3] || (jQuery.cssNumber[prop] ? "" : "px"), initialInUnit = (jQuery.cssNumber[prop] || unit !== "px" && +initial) &&
    ...
    jQuery.extend({
        ...
        ajax: function (url, options) {
            ...
            options = options || {};
            var transport, cacheURL, responseHeadersString, responseHeaders, timeoutTimer, urlAnchor, fireGlobals, i, s = jQuery.ajaxSetup({}, options), callbackContext = s.context || s, globalEventContext = s.context &&
...
(function (global) {
    var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript, mainScript, subPath, version = '2.2.0', commentRegExp = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg, cjsRequireRegExp = /[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g, jsSuffixRegExp = /\.js$/, currDirRegExp = /^\.\//, op = Object.prototype, ostring = op.toString, hasOwn = op.hasOwnProperty, isBrowser = !!(typeof window !== 'undefined' && typeof navigator !== 'undefined' && window.document), isWebWorker = !isBrowser && typeof importScripts !== 'undefined', readyRegExp = isBrowser && navigator.platform === 'PLAYSTATION 3' ?
...
define("src/KeyCode", ["require", "exports"], function (require, exports) {
    "use strict";
});
define("src/Todo", ["require", "exports"], function (require, exports) {
    "use strict";
    var Todo = (function (_super) {
        ...
        Object.defineProperty(Todo.prototype, "completed", {
            get: function () {
                return _super.prototype.get.call(this, "completed");
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Todo.prototype, "order", {
            get: function () {
                return _super.prototype.get.call(this, "order");
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Todo.prototype, "title", {
            get: function () {
                return _super.prototype.get.call(this, "title");
            },
            set: function (newTitle) {
                _super.prototype.set.call(this, "title", newTitle);
            },
            enumerable: true,
            configurable: true
        });
...
define("src/TodoList", ["require", "exports", "src/Todo"], function (require, exports, Todo_1) {
    "use strict";
    var TodoList = (function (_super) {
        __extends(TodoList, _super);
        function TodoList() {
            _super.apply(this, arguments);
            this.model = Todo_1.default;
...
define("src/State", ["require", "exports", "src/TodoList"], function (require, exports, TodoList_1) {
    "use strict";
    var StateInstance = (function () {
        function StateInstance() {
            this.taskFilter = "";
            this.todos = new TodoList_1.default();
        }
...
define("src/TodoRouter", ["require", "exports", "src/State"], function (require, exports, State_1) {
    "use strict";
    var TodoRouter = (function (_super) {
        ...
        TodoRouter.prototype.setFilter = function (filter) {
            if (filter === void 0) { filter = ""; }
            State_1.default.instance.todos.trigger("filter", filter);
        };
        return TodoRouter;
    }(Backbone.Router));
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("src/TodoView", ["require", "exports", "src/State"], function (require, exports, State_2) {
    "use strict";
    var TodoView = (function (_super) {
        ...
        TodoView.prototype.toggleVisible = function () {
            var hidden = (State_2.default.instance.taskFilter === "completed" && !this.model.completed) ||
                (State_2.default.instance.taskFilter === "active" && this.model.completed);
...
define("src/AppView", ["require", "exports", "src/State", "src/TodoRouter", "src/TodoView"], function (require, exports, State_3, TodoRouter_1, TodoView_1) {
    "use strict";
    var AppView = (function (_super) {
        ...
        function AppView() {
            ...
            State_3.default.instance.todos.bind("add", this.addOne);
            State_3.default.instance.todos.bind("all", this.render);
            State_3.default.instance.todos.bind("change:completed", this.filterOne);
            State_3.default.instance.todos.bind("filter", this.filter);
            State_3.default.instance.todos.bind("reset", this.addAll);
            State_3.default.instance.todos.fetch();
            new TodoRouter_1.default();
            Backbone.history.start();
        }
        AppView.prototype.render = function () {
            var completed = State_3.default.instance.todos.completed().length;
            var remaining = State_3.default.instance.todos.remaining().length;
            if (State_3.default.instance.todos.length) {
                this.mainElement.style.display = "block";
                this.footerElement.style.display = "block";
                this.$(".todo-stats").html(this.statsTemplate({
                    completed: completed,
                    remaining: remaining,
                    total: State_3.default.instance.todos.length
                }));
                this.$(".filters li a")
                    .removeClass("selected")
                    .filter("[href=\"#/" + State_3.default.instance.taskFilter + "\"]")
                    .addClass("selected");
            }
            else {
        ...
        AppView.prototype.addAll = function () {
            State_3.default.instance.todos.each(this.addOne);
        };
        AppView.prototype.addOne = function (todo) {
            var view = new TodoView_1.default(todo);
            this.$(".todo-list").append(view.render().el);
        };
        AppView.prototype.clearCompleted = function () {
            State_3.default.instance.todos.completed().forEach(function (todo) { return todo.destroy(); });
            return false;
        };
        AppView.prototype.createOnEnter = function (e) {
            if (e.which === 13 && this.input.val().trim()) {
                State_3.default.instance.todos.create(this.newAttributes());
                this.input.val("");
            }
        };
        AppView.prototype.filter = function (criteria) {
            State_3.default.instance.taskFilter = criteria;
            this.filterAll();
        };
        AppView.prototype.filterAll = function () {
            State_3.default.instance.todos.each(this.filterOne);
        };
        ...
        AppView.prototype.newAttributes = function () {
            return {
                completed: false,
                order: State_3.default.instance.todos.nextOrder(),
                title: this.input.val().trim()
            };
        };
        AppView.prototype.toggleAllComplete = function () {
            var completed = this.allCheckbox.checked;
            State_3.default.instance.todos.each(function (todo) { return todo.save({ "completed": completed }); });
        };
        return AppView;
    }(Backbone.View));
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("src/App", ["require", "exports", "src/AppView"], function (require, exports, AppView_1) {
    "use strict";
    $(function () {
        new AppView_1.default();
    });
});
